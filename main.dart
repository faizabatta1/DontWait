...
Future<void> main() async {
  ...
  //       UserType userType = await Authentication.determineUserType(user?.uid);
...
class UiApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      create: (_) => AuthChangeNotifier(logged:false,userType: UserType.UNKNOWN),
      child: MaterialApp(
        title: 'Dont Wait!',
