  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(widget.booking['test'],style: TextStyle(fontSize: 20, fontFamily: 'ultra',  color: Colors.white)),
      ),
      body: Column(
                ...
                height: 100,
                 child: Column(
                  children: [
                    ...
                    Text(widget.booking['test'],style: TextStyle(fontSize: 20, fontFamily: 'ultra',  color: Colors.teal)),
