                              ...
                              child: ElevatedButton(
                                ...
                                onPressed: () async{
                                  if(_formKey.currentState!.validate()){
                                    await createAndSendVerifyCode(email: emailController.text, context: context).then((codeStatus){
                                      if(codeStatus){
                                        Navigator.of(context).push(MaterialPageRoute(builder: (context){
                                          return ForgotPasswordVerificationPage(email:emailController.text,);
                                        }));
                                      }else{
