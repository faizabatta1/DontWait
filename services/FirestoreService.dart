...
class FirestoreService{
  ...
  static Future pushMessage({required String publisher,required String subscriber,required String content, required String subscriber_name, required publisher_name}) async{
